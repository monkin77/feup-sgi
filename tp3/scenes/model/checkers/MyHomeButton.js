...
export default class MyHomeButton {
    /**
     * 
    ...
    updatePosAndSize(newSideLength, monitorEnabled = false) {
        ...
        this._card = new MyRectangle(this._scene, "home-button-card", 0, this._cardLength, 0, this._cardHeight);
    }
     ...
     */
    displayHomeButton(isWhitePerspective) {
        ...
        displayText(this._scene, "HOME", this._monitorEnabled ? this._spacing / 2 : this._spacing / (5/3));
