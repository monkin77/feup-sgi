...
export default class MyRematchButton {
    /**
     * 
    ...
    updatePosAndSize(newSideLength, monitorEnabled = false) {
        ...
        this._card = new MyRectangle(this._scene, "rematch-button-card", 0, this._cardLength, 0, this._cardHeight);
    }
     ...
     */
    display() {
        this.displayRematchButton(true);
        this.displayRematchButton(false);
    }

    /**
     * Displays a score board at either side of the board
     */
    displayRematchButton(isWhitePerspective) {
        ...
        displayText(this._scene, "REMATCH", this._spacing / 2);
